...
//!
//! [`TemplateSource`]: usta_ports::template_source::TemplateSource
//! [`resolver`]: usta_core::resolver
    ...
    for op in &plan.ops {
        match op {
            ...
            FileOp::Inject {
                ...
                let mut rendered: Vec<usta_core::plan::AnchorContribution> = Vec::new();
                for c in contributions {
                    ...
                    let marker_present = source
                        .lines()
                        .any(|line| crate::__has_marker(line, &c.marker));
                    if !marker_present {
                    ...
                    rendered.push(usta_core::plan::AnchorContribution {
                        marker: c.marker.clone(),
