...
use usta_core::inject::apply_injections;
use usta_core::loaded::LoadedTemplate;
use usta_core::merge::{canonicalize_keys, deep_merge};
use usta_core::plan::{FileOp, MergeFormat, ScaffoldPlan};
use usta_core::snapshot::ManagedLock;
    ...
    for op in &plan.ops {
        match op {
            ...
            FileOp::Inject {
                ...
                let rendered_contributions: Vec<usta_core::plan::AnchorContribution> =
                    contributions
                        .iter()
                        .map(|c| {
                            ...
                            usta_core::plan::AnchorContribution {
