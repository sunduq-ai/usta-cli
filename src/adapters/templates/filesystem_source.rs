...
use crate::core::loaded::{
    InjectionFile, LoadedTemplate, MergeFile, TemplateContent, TemplateFile,
};
use crate::core::paths::to_forward_slashes;
use crate::core::plan::{AnchorContribution, MergeFormat};
use crate::core::template::{Template, TemplateId};
use crate::ports::template_source::{TemplateSource, TemplateSourceError};
...
"#,
    ...
    fn loads_manifest_and_files() {
        ...
        let extra_files = loaded
            .feature_files
            .get(&crate::core::template::FeatureId("extra".into()))
            .unwrap();
